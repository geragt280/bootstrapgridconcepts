...
export default function HomeScreen() {
  ...
  const [itemType, setitemType] = useState('Student')
    ...
    <div className='d-flex justify-content-center align-items-center vh-100 main-container'>
      <div className='container grid-box'>
        <div className='row tab-bar '>
          <div className='d-flex m-2 col justify-content-center '>
            <p className='p-1'>
            <b>Students</b>
            </p>
          </div>
          <div className='d-flex m-2 col justify-content-center tab-bar-border'>
            <p className='p-1'>
              <b>Books</b>
            </p>
          </div>
